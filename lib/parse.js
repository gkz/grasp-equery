...
(function(){
  ...
  function processNode(node){
    var nodeType, name, that, ident, attrs, n, processedAttrs, i$, len$, attr, nodeKey, nodeValue;
    nodeType = node.type;
    ...
    } else if (!nodeType && node.key != null && node.value != null) {
      nodeKey = node.key, nodeValue = node.value;
      if (nodeKey.type === 'Identifier' && nodeKey.name === '_' && nodeValue.type === 'Identifier' && /^\$/.test(nodeValue.name)) {
        return {
          type: 'Grasp',
          graspType: 'array-wildcard',
